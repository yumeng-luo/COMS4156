...
public class ControllerIntegrationTest {
  ...
  // Tests that the tested alternative above is properly chosen as purchased item
  ...
  public void purchaseValidItemName() throws Exception {
    ...
    Map<String, Object> map = new HashMap<>();
    map.put("upc", "87525200015");
    map.put("lat", "37.663057514");
    map.put("lon", "-77.63599813");
  ...
  @Test
  @Order(7)
  public void noConfirmationNoSaving() throws SQLException {
    DatabaseJdbc database = Controller.getDb();
    User user = DatabaseJdbc.getUser(database, "User", "105222900313734280075");
    newSavings = user.getSavings();
  ...
  */
  ...
  @Test
  @Order(9)
  public void confirmationYesSaving() throws SQLException {
